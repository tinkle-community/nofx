...
export const translations = {
  en: {
    ...
    overrideBaseStrategyWarning: '⚠️ Warning: Checking this will completely use your custom strategy and no longer use the system default risk control and trading logic. This may increase trading risk. Use this option only when you fully understand the trading logic.',
  ...
  zh: {
    ...
    editExchange: '编辑交易所',
    addExchange: '添加交易所',
    initialFunds: '初始资金 (USDT)',
    marginMode: '仓位模式',
    crossMargin: '全仓模式',
    isolatedMargin: '逐仓模式',
    crossMarginDesc: '全仓模式：所有仓位共享账户余额作为保证金',
    isolatedMarginDesc: '逐仓模式：每个仓位独立管理保证金，风险隔离',
    advancedSettings: '高级设置',
    customStrategy: '自定义交易策略',
    customStrategyOptional: '自定义交易策略 (可选)',
    customStrategyPlaceholder: '例如：专注于主流币种BTC/ETH/SOL，避免MEME币。使用保守策略，单笔仓位不超过账户的30%...',
    customStrategyDesc: '输入自定义的交易策略和规则，将作为AI交易员的额外指导。留空使用默认策略。',
    overrideBaseStrategy: '覆盖基础交易策略',
    overrideBaseStrategyWarning: '⚠️ 警告：勾选后将完全使用您的自定义策略，不再使用系统默认的风控和交易逻辑。这可能导致交易风险增加。仅在您完全理解交易逻辑时使用此选项。',
    privateKey: 'Private Key (无需0x前缀)',
    walletAddress: '钱包地址',
    userAddress: '用户地址',
    signerAddress: '签名者地址',
    enterApiKey: '请输入 API Key',
    binanceApiKey: '请输入 Binance API Key',
    binanceSecretKey: '请输入 Binance Secret Key',
    hyperliquidPrivateKey: '请输入以太坊私钥',
    hyperliquidWalletAddr: '请输入以太坊钱包地址',
    asterUser: '请输入 Aster 用户地址',
    asterSigner: '请输入 Aster 签名者地址',
    asterPrivateKey: '请输入 Aster 私钥',
    createTraderFailed: '创建交易员失败',
    deleteTraderFailed: '删除交易员失败',
    deleteConfigFailed: '删除配置失败',
    saveConfigFailed: '保存配置失败',
    deleteExchangeConfigFailed: '删除交易所配置失败',
    saveExchangeConfigFailed: '保存交易所配置失败',
