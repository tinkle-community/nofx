...
export const translations = {
  en: {
    ...
    confirmCloseAllPositions: 'Are you sure you want to close all positions?',
    confirmClosePosition: 'Are you sure you want to close this position?',
    closeAllPositionsSuccess: 'All positions closed successfully',
    closeAllPositionsFailed: 'Failed to close all positions',
    closePositionSuccess: 'Position closed successfully',
  ...
  zh: {
    ...
    closePosition: '平仓',
    confirmCloseAllPositions: '确定要平仓所有持仓吗？',
    confirmClosePosition: '确定要平仓这个持仓吗？',
    closeAllPositionsSuccess: '所有持仓已平仓',
    closeAllPositionsFailed: '平仓失败',
    closePositionSuccess: '持仓已平仓',
